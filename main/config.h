...
#define GENERAL_MACHINE_CURRENT_LIMIT 60.0f

#define IGNORE_NOZZLE_BLOCK false
#define TEMP_MIN_MOVE 170
#define TEMP_CRITICAL 150
#define TEMP_CRITICAL_RECOVER 175
#define TEMP_CALIB_SCALE                                                       \
  1.1628f // Two-point fit (raw->real): (31->40, 160->190)
#define TEMP_CALIB_OFFSET_C 4.0f   // Two-point fit offset (approx)
...
#define TEMP_MAX_VALID_C 320.0f

// Contactor cycle tracking
#define CONTACTOR_CYCLE_LIMIT 50000
#define CONTACTOR_WARN_THRESHOLD 0.75f
...
#define PRESSURE_BLOCK_MIN_DIST_TURNS                                          \
  30.0f // From refill start before block check
...
#define HOMING_FAST_CURRENT 20.0f
#define HOMING_BACKOFF_VEL 5.0f
#define HOMING_BACKOFF_DURATION 2500
...
#define REFILL_CURRENT_LIMIT 25.0f
#define REFILL_FROM_BARREL_END_TIMEOUT_MS                                      \
  ((uint32_t)((POS_BOTTOM_MAX / REFILL_TRAP_VEL_LIMIT) * 1000.0f + 2000.0f))

#define COMPRESS_TRAVEL_VEL_LIMIT 10.0f
...
#define COMPRESS_MICRO_CURRENT 15.0f
...
#define PURGE_CURRENT_LIMIT 15.0f
#define PURGE_PRE_RETRACT_TURNS -2.0f

#define ANTIDRIP_VEL -2.0f
#define ANTIDRIP_VEL_LIMIT 5.0f
#define ANTIDRIP_CURRENT_LIMIT 15.0f
#define ANTIDRIP_TIMEOUT_MS 20000
...
#define RELEASE_CURRENT_LIMIT 40.0f
